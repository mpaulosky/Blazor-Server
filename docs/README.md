...
| [v0.0.19](https://github.com/mpaulosky/Blazor-Server/releases/tag/v0.0.19) | 2026-09-24 | chore(hooks): Fix pre-push test command, npm package name, and review prompt | — |
